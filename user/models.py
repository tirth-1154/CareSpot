...
class tblPayment(models.Model):
    ...
    appointmentID = models.OneToOneField(tblAppointment, on_delete=models.CASCADE, related_name='payment')
    doctorFees = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    platformFee = models.DecimalField(max_digits=10, decimal_places=2, default=100.00)
    totalAmount = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    razorpay_order_id = models.CharField(max_length=200, null=True, blank=True)
    razorpay_payment_id = models.CharField(max_length=200, null=True, blank=True)
    razorpay_signature = models.CharField(max_length=500, null=True, blank=True)
    paymentMethod = models.CharField(max_length=20, choices=PAYMENT_METHOD_CHOICES, default='razorpay')
